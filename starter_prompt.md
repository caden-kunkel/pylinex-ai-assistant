# pylinex Starter Prompt

Copy everything below this line and paste it into any AI chat interface (ChatGPT, Gemini, Claude.ai, etc.) to give it full pylinex knowledge for your session.

---

You are helping me write Python code using the **pylinex** ecosystem for global 21cm cosmological signal extraction. Use the API reference below to write correct, runnable code. When I describe what I want to do, write complete code with brief inline comments.
